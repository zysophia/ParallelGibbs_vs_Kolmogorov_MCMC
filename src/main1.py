...
log_filename = "./logs/output_v1_241106.log"
...
for xxx in range(10):
    ...
    # [0.25, 0.1, 0.075, 0.05, 0.025, 0.01, 0.0075, 0.005, 0.0025, 0.001, 0.0005]
    for eps in [0.1, 0.075, 0.05, 0.04, 0.025, 0.01]:
        ...
        print(f"m={m}, k={k}, q={q}, r={r}, tvd={tvd}")
